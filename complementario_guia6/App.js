...
const App = () =>{
  const[modalVisiblehabitaciones,setModalVisibleHabitaciones]= useState(false);
...
<>
<ScrollView>
<Modal transparent={true} animationType="slide" visible={modalVisiblehabitaciones} onRequestClose={() => {
  alert('Modal has been closed.');
}} >
<View style={styles.vistaModal}>
<View style={styles.Modal}>
<Text style={styles.subtitulo}>Tipos de Habitaciones</Text>
<Text>El hotel Crowne Plaza ofrece habitaciones individuales, dobles de uso individual, twin o doble con camas individuales, dobles, triples y cuádruples.</Text>
<Button title="Cerrar" onPress={()=>{setModalVisibleHabitaciones(!modalVisiblehabitaciones)}}></Button>
</View>
</View>
</Modal>
...
<View style={styles.vistaModal}>
<View style={styles.Modal}>
<Text style={styles.subtitulo}>Servicios que ofrece Crowne Plaza</Text>
<Text>Los servicios disponibles dentro del hotel son: Minibar, café y té, piscinas, saunas y gimnasios.</Text>
<Button title="Cerrar" onPress={()=>{setModalVisibleServicios(!modalVisibleservicios)}}></Button>
</View>
</View>
</Modal>

<Modal transparent={true} animationType="slide" visible={modalVisiblelugares} onRequestClose={() => {
  alert('Modal has been closed.');
}} >
<View style={styles.vistaModal}>
<View style={styles.Modal}>
<Text style={styles.subtitulo}>Lugares Cercanos al Hotel</Text>
<Text>Dentro de los lugares más cercanos al hotel podemos mencionar: La pupuseria Suiza Escalón, Plaza Palestina, Essenza Coffee y Restaurante El Mirador.</Text>
<Button title="Cerrar" onPress={()=>{setModalVisibleLugares(!modalVisiblelugares)}}></Button>
</View>
</View>
</Modal>
...
<View>
<TouchableHighlight
onPress={()=>{setModalVisibleHabitaciones(!modalVisiblehabitaciones)}}
>
<Image
...
<View>
<TouchableHighlight
onPress={()=>{setModalVisibleServicios(!modalVisibleservicios)}}
>
<Image
...
<TouchableHighlight
onPress={()=>{setModalVisibleLugares(!modalVisiblelugares)}}
>
<Image
style={styles.servicios}
